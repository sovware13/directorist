...
//         const id = generateRandom( 100, 999 );
//         rootElement.setAttribute( 'data-lazy-check-root-element-id', id );

//         // Prepare Root Element
//         prepareRootElement( id );

//         // Load initial data
//         const initData = fetchData( id );
//         console.log({ initData });

//         let itemsContainer = rootElement.querySelector( '.directorist-lazy-check-items' );
...
//         const toggle = rootElement.querySelector( '.directorist-lazy-check-show-more-toggle' );
...
//     function prepareRootElement( id ) {
...
//             rootElement.append( itemsContainer );
//         }

//         let showMoreArea = rootElement.querySelector( '.directorist-lazy-check-show-more-area' );

//         if ( ! showMoreArea ) {
//             showMoreArea = document.createElement('div');
//             showMoreArea.classList = 'directorist-lazy-check-show-more-area';

//             insertAfter( itemsContainer, showMoreArea );
//         }
...
//         toggleLink.classList = `directorist-lazy-check-show-more-toggle ${args.showMoreToggleClass}`;
//         toggleLink.innerHTML = args.showMorelabel;
...
//     function insertAfter( targetElement, subject ) {
...
//         // const formData = args.ajax.data({ page: _page });
